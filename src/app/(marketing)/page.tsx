    ...
    <>
      ...
      <section className="relative pt-20 md:pt-28 pb-8 md:pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6">
          ...
          >
            <div className={`inline-flex flex-row items-center divide-x rounded-full border text-xs sm:text-sm ${
              isDark
              ...
              <div className="flex items-center gap-2 px-4 py-2">
                ...
                <span className={isDark ? "text-gray-300" : "text-gray-700"}>
                  <span className="font-semibold">95%</span> Email Coverage
                </span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2">
              ...
              <div className="overflow-x-auto hidden md:block">
                <div className="min-w-[750px]">
                  ...
                  <div className={`grid grid-cols-5 gap-4 p-6 md:p-8 ${isDark ? "border-b border-white/[0.06]" : "border-b border-gray-100"}`}>
                    ...
                    {[
                      { name: "Workflow Builders", sub: "Clay, etc.", favicon: "/images/favicons/clay.png", bgcolor: "white" },
                      { name: "CRM Enrichment", sub: "Apollo, ZoomInfo", favicon: "/images/favicons/apollo.jpeg", bgcolor: "yellow" },
                      { name: "Signal Platforms", sub: "6sense, etc.", favicon: "/images/favicons/6sense.svg", bgcolor: "white" },
                    ].map((col, i) => (
                      <motion.div
                        key={col.name}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          >
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
              <div>
                <h3 className={`text-xl md:text-2xl lg:text-3xl font-semibold mb-1 ${isDark ? "text-white" : "text-gray-900"}`}>
                  Native Integrations
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="mb-4">
                <h3 className={`text-lg md:text-xl lg:text-2xl font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>Pro</h3>
                <div className="flex gap-1 mt-2">
