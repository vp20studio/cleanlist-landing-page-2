        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <h3 className={`text-lg md:text-xl font-bold mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>Partial Enrichment</h3>
            ...
            >
              ...
              <h3 className={`text-lg md:text-xl font-bold mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>Full Enrichment</h3>
