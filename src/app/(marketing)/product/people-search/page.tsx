        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className={`text-xl mb-8 max-w-2xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}>
              Get 25 free searches to test our database. No credit card required.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                href="https://portal.cleanlist.ai/auth/register"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#3e8aff] text-white font-medium rounded-lg hover:bg-[#3e8aff]/90 transition-colors text-lg shadow-lg shadow-[#3e8aff]/25"
              >
                Start Searching Free
                <ArrowRight />
              </Link>
