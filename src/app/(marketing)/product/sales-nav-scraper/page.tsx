                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-4 p-3 rounded-lg bg-[#0077b5]/10 border border-[#0077b5]/30">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button className="px-3 py-2 rounded border border-white/[0.1] text-xs text-gray-400">
                          Select
                        </button>
                      </div>
                    </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              {[
                ...
                <div key={item.title} className="p-4 rounded-lg bg-[#0a0a0a] border border-white/[0.08]">
