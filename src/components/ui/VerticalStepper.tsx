    ...
    <div className={`relative ${className}`}>
      ...
      <div className="space-y-12">
        {steps.map((step, index) => (
          ...
          >
            {/* Step Number Circle */}
            <div className="absolute left-0 top-0 w-12 h-12 rounded-full bg-[#0a0a0a] border-2 border-[#3e8aff] flex items-center justify-center z-10">
              {step.icon ? (
            ...
            {/* Content Card */}
            <div className="bg-[#0a0a0a] border border-white/[0.08] rounded-xl p-6 hover:border-[#3e8aff]/30 transition-colors">
              ...
              {step.visual && (
                <div className="mt-4 rounded-lg overflow-hidden border border-white/[0.05]">
                  {step.visual}
                </div>
              )}
            </div>
